...
type Page = "login" | "register" | "dashboard" | "watch" | "account" | "profile" | "help";
...
export default function App() {
  ...
  if (page === "account") {
    return <AccountPage onBack={() => setPage("dashboard")} onNavigate={(destination) => setPage(destination)} />;
  }

  if (page === "profile") {
    return <ProfilePage onBack={() => setPage("dashboard")} onNavigate={(destination) => setPage(destination)} />;
  }

  if (page === "help") {
    return <HelpPage onBack={() => setPage("dashboard")} onNavigate={(destination) => setPage(destination)} />;
  }
