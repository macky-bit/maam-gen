...
const WINE = "var(--color-wine)";
const CREAM = "var(--color-cream)";
const TAUPE = "var(--color-taupe)";
const STONE = "var(--color-stone)";
const RED = "var(--color-red)";
const STONE_BORDER = "var(--color-stone)";
const INK_GLASS = "var(--color-ink)";
const WINE_TINT = "var(--color-wine)";
...
function IconBtn({
	...
	return (
		<button
			...
			onClick={onClick}
			style={{
				background: active ? STONE_BORDER : "var(--color-ink)",
			...
			{canLeft && (
				<button
					...
					style={{
						...
						zIndex: 10,
						background:
							"linear-gradient(to right, var(--color-ink) 60%, transparent)",
						border: "none",
						cursor: "pointer",
						color: CREAM,
						width: 48,
			...
			{canRight && (
				<button
					...
					style={{
						...
						zIndex: 10,
						background:
							"linear-gradient(to left, var(--color-ink) 60%, transparent)",
						border: "none",
						cursor: "pointer",
						color: CREAM,
						width: 48,
		...
		>
			...
			<div
				style={{
					...
					borderRadius: 6,
					overflow: "hidden",
					background: show.bg || "var(--color-ink-soft)",
						...
						>
							...
							<div
								style={{
									...
									inset: 0,
									background:
										"linear-gradient(to top, var(--color-ink) 0%, transparent 50%)",
								}}
							/>
							<div
								style={{
		...
		<div ref={ref} style={{ position: "relative", display: "inline-block" }}>
			<button
				...
				style={{
					...
					alignItems: "center",
					gap: 6,
					background: open ? "var(--color-stone)" : "var(--color-ink)",
			...
			{open && (
				<div
					style={{
						...
						border: `1px solid ${STONE_BORDER}`,
						borderRadius: 8,
						boxShadow: "0 16px 48px var(--color-ink)",
						padding: "8px 4px",
						minWidth: 480,
					}}
				>
		...
		>
			...
			<div
				style={{
					position: "absolute",
					inset: 0,
					background: `linear-gradient(to right, ${INK} 0%, var(--color-ink) 45%, transparent 75%)`,
				}}
			/>
			{/* Bottom gradient */}
			<div
		...
		>
			<div
				style={{
					...
					border: `1px solid ${STONE_BORDER}`,
					borderRadius: 12,
					boxShadow: "0 24px 80px var(--color-ink)",
				}}
				className={styles.noScrollbar}
			>
				{/* Hero image */}
				...
				>
					...
					<div
						style={{
							...
							inset: 0,
							background:
								"linear-gradient(to top, var(--color-ink-soft) 0%, var(--color-ink-soft) 40%, transparent 70%)",
						}}
					/>
									...
									>
										<div
											style={{
												...
												paddingTop: "56%",
												position: "relative",
												background: s.bg || "var(--color-ink-soft)",
											}}
										>
											<img
												src={s.poster}
