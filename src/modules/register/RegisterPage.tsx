					...
					>
						...
						<div className="flex flex-col gap-1">
							<label className="flex items-start gap-2.5 cursor-pointer select-none">
								...
								/>
								<span
									className={`text-xs leading-relaxed ${styles.checkboxLabel}`}
								>
									I agree to the{" "}
									<button
										type="button"
										className="underline hover:text-[var(--color-cream)] transition-colors"
									>
										Terms of Service
									</button>{" "}
									and{" "}
							...
							{errors.terms && (
								<p className={`text-[11px] pl-6 ${styles.errorText}`}>
									{errors.terms}
								</p>
							)}
						</div>
