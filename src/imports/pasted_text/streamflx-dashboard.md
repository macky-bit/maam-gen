...
## 13. FIGMA FILE ORGANIZATION — IMPORTANT
...
**04 — COMPONENTS:** Dedicated design-system page. Build these as **true Figma components with variants** (Default / Hover / Active / Selected / Disabled) — not duplicated static frames. Include: StreamFlix Logo, Buttons, Input fields, Password fields, Checkboxes, Navigation items, Movie cards, Genre pills, Progress bars, Icons, Dropdowns, Modals, Cards, Dividers.

**05 — RESPONSIVE:** Desktop 1920×1080, Desktop 1440×900, Tablet 768×1024, Mobile 390×844 — clearly organized.
